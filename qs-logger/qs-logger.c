...
//        }
    ...
    const uint8_t *pui8SplashLogo = g_pui8Image_TI_Black;
//    const uint8_t *pui8SplashLogo = g_ppui8Image_Splash;



    //GrImageDraw(&sDisplayContext, pui8SplashLogo, 95 - ui8X, 0);

    g_sConfigState.ui16SelectedMask = 0xffff;
    ...
    extern int16_t g_i16Accel[3];
    while(1)
    {

        ui8Y = (g_i16Accel[0]*0.1);
        ui8X = (g_i16Accel[1]*0.1);

//        GrStringDraw(&sDisplayContext,"a", -1, 10, 5, 0);
//        GrImageDraw(&sDisplayContext, pui8SplashLogo, 95 - ui8X, 0);
//        //
...
//        //
        ...
        {
//            GrStringDraw(&sDisplayContext, "dasdsa", -1, 10, 8, 1);
                    GrImageDraw(&sDisplayContext, pui8SplashLogo, ui8X, ui8Y);
            //
